...
mod sql_execution_tests {
    ...
    fn test_native_query_builder_simple() {
        ...
        let query = NativeQuery::builder("SELECT * FROM orders")
            .build();
    ...
    fn test_native_query_builder_with_number_param() {
        ...
        assert_eq!(query.query, "SELECT * FROM orders WHERE amount > {{min_amount}}");
    ...
    fn test_native_query_builder_with_date_param() {
        ...
        assert_eq!(query.query, "SELECT * FROM orders WHERE created_at > {{start_date}}");
